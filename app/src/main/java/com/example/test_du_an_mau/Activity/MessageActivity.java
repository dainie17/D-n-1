...
import com.example.test_du_an_mau.Adapter.MessageAdapter;
...
public class MessageActivity extends AppCompatActivity {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, "Gửi tin nhắn thất bại !!", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
    ...
    // cập nhật lại dữ liệu tin nhắn của người gửi
