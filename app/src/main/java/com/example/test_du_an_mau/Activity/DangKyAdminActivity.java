...
public class DangKyAdminActivity extends AppCompatActivity {
    ...
    private void register(String hoten, String email, String pass) {
        ...
        dialog = Utils.showLoader(DangKyAdminActivity.this);
                        ...
                        if (task.isSuccessful()){
                            ...
                            reference.setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Intent intent = new Intent(DangKyAdminActivity.this, MainActivity.class);
                            ...
                            Toast.makeText(DangKyAdminActivity.this, "You can't register woth this email or password", Toast.LENGTH_SHORT).show();
                            if(dialog!=null){
                                dialog.dismiss();
                            }
                        }
    ...
    private View.OnClickListener dangnhap() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DangKyAdminActivity.this, DangNhapActivity.class);
                startActivity(i);
            }
